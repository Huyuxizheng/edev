...
#define CMD_WRITE_STATUS_R1     0x05a0    //data
#define CMD_WRITE_STATUS_R2     0x05b0    //data
#define CMD_WRITE_STATUS_R3     0x05c0    //data
...
#define CMD_PROGRAM_EXECUTE     0x84    //addr24bit
